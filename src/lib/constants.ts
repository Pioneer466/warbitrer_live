...
export const KALSHI_WS_PROD_FALLBACK_BASE = "wss://api.elections.kalshi.com/trade-api/ws/v2";
export const KALSHI_WS_DEMO_BASE = "wss://external-api-ws.demo.kalshi.co/trade-api/ws/v2";
export const KALSHI_WS_DEMO_FALLBACK_BASE = "wss://demo-api.kalshi.co/trade-api/ws/v2";
...
export const DEFAULT_MAX_LEG_PRICE = 0.7;
...
export const DEFAULT_MISMATCH_GUARD_MODE = "hard_only";
...
export const DEFAULT_MISMATCH_RISK_MODE = "shadow";
...
export const DEFAULT_STRATEGY_CONFIG = {
  ...
  mismatchGuardMode: DEFAULT_MISMATCH_GUARD_MODE,
  ...
  mismatchRiskMode: DEFAULT_MISMATCH_RISK_MODE,
} as const;
