...
const envSchema = z.object({
  ...
  DB_MAINTENANCE_INTERVAL_MINUTES: z.string().optional(),
  DB_RETENTION_SNAPSHOTS_HOURS: z.string().optional(),
  DB_RETENTION_PNL_DAYS: z.string().optional(),
  DB_RETENTION_RUN_EVENTS_DAYS: z.string().optional(),
  DB_RETENTION_FILLS_DAYS: z.string().optional(),
  DB_RETENTION_ORDERS_DAYS: z.string().optional(),
  DB_RETENTION_CLOSED_INTENTS_DAYS: z.string().optional(),
  DB_RETENTION_SETTLEMENTS_DAYS: z.string().optional(),
  DB_RETENTION_BRIDGE_TRANSFERS_DAYS: z.string().optional(),
