...
The current schema history is V1-V10:
...
10. immutable entry-execution probes, versioned mismatch-calibration artifacts with audited activation, and calibration-revision binding in entry admission
